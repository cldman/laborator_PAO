...
public class MainFrame extends JFrame{
    ...
    private void button1ActionPerformed(ActionEvent e) {
        ...
        AccountType type = AccountType.valueOf(comboBox1.getSelectedItem().toString());
        String cardNumber = textField3.getText();
        accountService.addAccount(new Account(accountNumber, balance, type, cardNumber));
    ...
    private void displayBankAccounts() {
        listModel.clear();
        accountService.getAllAccounts().forEach(account -> listModel.addElement(account));
    }
